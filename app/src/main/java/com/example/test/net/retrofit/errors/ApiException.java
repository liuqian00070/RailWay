...
import com.example.test.GsonUtil;
import com.example.test.net.retrofit.api.BaseApiResult;
...
public class ApiException extends Exception {
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            try {
                String httpErrorStr = httpException.response().errorBody().string();
                BaseApiResult baseApiResult = GsonUtil.jsonToBean(httpErrorStr, BaseApiResult.class);
                String message = baseApiResult.getMessage();
                String errorMsg = baseApiResult.getError_message();
                int code = baseApiResult.getError_code();
                ex.message = String.format("%s, %s", code, TextUtils.isEmpty(errorMsg) ? message : errorMsg);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
            return ex;
